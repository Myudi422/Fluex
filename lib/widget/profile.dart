...
Future<Map<String, dynamic>> fetchAkses(int telegramId) async {
  final apiUrl =
      'https://ccgnimex.my.id/v2/android/cek_akses.php?telegram_id=$telegramId';
...
Future<List<Map<String, dynamic>>> fetchNotifications() async {
  final response = await http.get(Uri.parse(
      'https://ccgnimex.my.id/v2/android/notif.php')); // Ganti URL sesuai dengan URL API.php Anda
  if (response.statusCode == 200) {
    // Jika request sukses
...
Future<List<Map<String, dynamic>>> fetchLeaderboard(int telegramId) async {
  final apiUrl =
      'https://ccgnimex.my.id/v2/android/leaderboard/api.php?telegram_id=$telegramId';
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => ProfileMenu(
                        firstName: firstName,
                        profilePicture:
                            finalProfilePicture, // Use finalProfilePicture here
                      ...
                      FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            final totalPoints =
                                snapshot.data?[0]['total_points'] ?? 0;
                            return Container(
                              decoration: BoxDecoration(
                                color: ColorManager.currentPrimaryColor,
                                borderRadius: BorderRadius.circular(5.0),
                                      ...
                                      children: [
                                        IconButton(
                                          icon: FaIcon(FontAwesomeIcons
                                              .telegram), // Ikon Telegram dari Font Awesome
                                          onPressed: () {
                ...
                BlurredIcon(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              CariPage(telegramId: telegramId)),
                    );
                  },
                ),
              ],
