...
import '../anime-detail/streaming/core/convertdurasi.dart';
...
class HistoryTab extends StatefulWidget {
  ...
  HistoryTab({super.key, required this.telegramId, required this.mytelegram});
...
class _HistoryTabState extends State<HistoryTab> {
  ...
  Widget _buildShimmerList() {
    return Shimmer.fromColors(
      baseColor: const Color.fromARGB(255, 15, 15, 15)!,
      highlightColor: const Color.fromARGB(255, 47, 47, 47)!,
...
class AnimeHistoryItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      color: Colors.grey[850], // Set warna background container
      elevation: 3.0,
      margin: EdgeInsets.symmetric(vertical: 8.0),
      child: InkWell(
        onTap: () {
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                          fontSize: 20.0,
                          fontWeight: FontWeight.bold,
                          color: Colors.white), // Set warna teks
                    ),
                    SizedBox(height: 8.0),
                    Text(
