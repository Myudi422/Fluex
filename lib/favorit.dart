...
class _FavoritWidgetState extends State<FavoritWidget> {
  ...
  Future<void> _fetchAnimeData() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          'https://ccgnimex.my.id/v2/android/fav_user.php?telegram_id=${widget.telegramId}'));
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ...
          style: TextStyle(
              color:
                  ColorManager.currentHomeColor), // Ubah teks jadi warna putih
        ),
        backgroundColor: ColorManager
            .currentBackgroundColor, // Ubah latar belakang jadi hitam
        iconTheme: IconThemeData(
            color: ColorManager.currentHomeColor), // Ubah ikon jadi warna putih
      ),
      backgroundColor: ColorManager
          .currentBackgroundColor, // Ubah latar belakang Scaffold jadi hitam
      body: _isLoading
          ? Center(
              child: CircularProgressIndicator(
                color: ColorManager
                    .currentHomeColor, // Ubah warna CircularProgressIndicator jadi putih
              ),
            )
          : _animeData.isEmpty
              ? Center(
                  child: Text(
                    ...
                    style: TextStyle(
                        color: ColorManager
                            .currentHomeColor), // Ubah teks jadi warna putih
                  ),
                )
              : ListView.builder(
                    ...
                    return GestureDetector(
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => AnimeDetailPage(
                              animeId: int.parse(anime[
                                  'anime_id']), // Konversi tipe data String ke int
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: ColorManager.currentAccentColor.withOpacity(
                              0.3), // Ganti background card jadi lebih gelap
                                      ...
                                      children: [
                                        IconButton(
                                          icon: Icon(Icons.close,
                                              color: ColorManager
                                                  .currentHomeColor), // Ubah ikon jadi warna putih
                                          onPressed: () {
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: ColorManager.currentHomeColor
                                            .withOpacity(
                                                0.6), // Ubah teks jadi lebih terang
                                      ),
                                    ),
                                  ],
                                ),
  ...
  Future<void> _showDeleteConfirmationDialog(
      String animeId, String animeTitle) async {
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text(
                  'Apakah Anda yakin ingin menghapus "$animeTitle" dari favorit Anda?',
                  style: TextStyle(
                      color: ColorManager
                          .currentHomeColor), // Ubah teks jadi warna putih
                ),
